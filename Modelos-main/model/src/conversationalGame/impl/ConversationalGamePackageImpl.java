...
public class ConversationalGamePackageImpl extends EPackageImpl implements ConversationalGamePackage {
	 ...
	 * @generated
	 */
	public EAttribute getGame_Greeting() {
	 ...
	 * @generated
	 */
	public EReference getGame_ItemList() {
	 ...
	 * @generated
	 */
	public EReference getGame_NpcList() {
	...
	public void createPackageContents() {
		...
		createEAttribute(gameEClass, GAME__GREETING);
		createEReference(gameEClass, GAME__ITEM_LIST);
		createEReference(gameEClass, GAME__NPC_LIST);
		...
		createEAttribute(npcEClass, NPC__ID);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGame_Greeting(), ecorePackage.getEString(), "Greeting", null, 1, 1, Game.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGame_ItemList(), this.getItem(), null, "ItemList", null, 0, -1, Game.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGame_NpcList(), this.getNpc(), null, "NpcList", null, 0, -1, Game.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNpc_Id(), ecorePackage.getEString(), "Id", null, 1, 1, Npc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
