 ...
 *   <li>{@link conversationalGame.Npc#getId <em>Id</em>}</li>
 * </ul>
 *
...
public interface Npc extends conversationalGame.Character {
	 ...
	 * @see #setId(String)
	 * @see conversationalGame.ConversationalGamePackage#getNpc_Id()
	 * @model required="true"
	 * @generated
	 */
	String getId();
	...
	/**
	 * Sets the value of the '{@link conversationalGame.Npc#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
